...
import com.kankankeke.reggie.entity.AddressBook;
import com.kankankeke.reggie.service.AddressBookService;
...
public class AddressBookController {
    ...
    public Result<AddressBook> save(@RequestBody AddressBook addressBook) {
        ...
        /*
        * 这里留了个坑，我把数据库create_Id和更新时间等字段改成了非空了，算是遗留Bug,create_user和update_user没有勾选不是null
