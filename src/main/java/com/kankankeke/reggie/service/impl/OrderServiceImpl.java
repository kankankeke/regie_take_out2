...
import com.kankankeke.reggie.entity.*;
import com.kankankeke.reggie.mapper.OrderMapper;
import com.kankankeke.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
     ...
     * @param orders
     */
    @Transactional//需要操作多次数据库，添加事务注解
    public void submit(Orders orders) {
        ...
        List<OrderDetail> orderDetails = shoppingCarts.stream().map((item) -> {
            ...
            //累加（addAndGet相当于+=），单价（getAmount）乘以（multiply）份数（getNumber）
