...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='地址管理';
...
INSERT INTO `address_book` VALUES ('1541359297990533121', '1541358513722793986', '11', '1', '13812345678', null, null, null, null, null, null, 'china', '公司', '0', '2022-06-27 17:54:28', '2022-06-27 17:54:28', '1417012167126876162', '1417012167126876162', '0');
INSERT INTO `address_book` VALUES ('1541359368798773250', '1541358513722793986', 'geforcelit', '1', '13112345678', null, null, null, null, null, null, 'china', '公司', '1', '2022-06-27 17:54:45', '2022-06-27 17:54:47', '1417012167126876162', '1417012167126876162', '0');
INSERT INTO `address_book` VALUES ('1541359670314725378', '1541355937010843649', 'geforcelit', '1', '13112345678', null, null, null, null, null, null, 'china', '公司', '0', '2022-06-27 17:55:57', '2022-06-27 17:55:58', '1417012167126876162', '1417012167126876162', '0');
INSERT INTO `address_book` VALUES ('1597509838809931778', '1541355937010843649', '小华', '1', '13512345678', null, null, null, null, null, null, '青海大厦', '公司', '1', '2022-11-29 16:36:41', '2022-11-29 16:42:46', '1541355937010843649', '1541355937010843649', '0');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='菜品及套餐分类';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='菜品管理';
...
INSERT INTO `dish` VALUES ('1595713922444582913', '烤鸡', '1397844391040167938', '4100.00', '', '608eb4c6-04a1-4458-9d22-14faac8e0a8b.jpg', '大', '0', '0', '2022-11-24 17:40:21', '2022-11-24 17:49:41', '1', '1', '0');
...
CREATE TABLE `dish_flavor` (
  ...
  `is_deleted` int(11) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='菜品口味关系表';
...
INSERT INTO `dish_flavor` VALUES ('1595713922507497473', '1595713922444582913', '温度', '[\"常温\"]', '2022-11-24 17:40:21', '2022-11-24 17:40:21', '1', '1', '0');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='员工信息';

-- ----------------------------
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES ('1', '管理员', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '13812312312', '1', '110101199001010047', '1', '2021-05-06 17:20:07', '2022-10-29 11:28:13', '1', '1');
INSERT INTO `employee` VALUES ('1586198155118272513', 'liu', 'test001', 'e10adc3949ba59abbe56e057f20f883e', '13222223333', '1', '444411112222333322', '1', '2022-10-29 11:28:05', '2022-10-30 15:13:17', '1', '1');
INSERT INTO `employee` VALUES ('1595700110718980098', 'lin', '23123', 'e10adc3949ba59abbe56e057f20f883e', '13455555555', '1', '441325111198763765', '0', '2022-11-24 16:45:28', '2022-11-24 16:45:44', '1', '1');
...
INSERT INTO `orders` VALUES ('1598206150136061954', '1598206150136061954', '2', '1541355937010843649', '1597509838809931778', '2022-12-01 14:44:14', '2022-12-01 14:44:14', '1', '276.00', '', '13512345678', '青海大厦', null, '小华');
...
CREATE TABLE `order_detail` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='订单明细表';
...
INSERT INTO `order_detail` VALUES ('1598206433184473090', '全家福', 'a53a4e6a-3b83-4044-87f9-9d49b30a8fdc.jpg', '1598206150136061954', '1397851099502260226', null, '不要蒜,不辣', '2', '118.00');
INSERT INTO `order_detail` VALUES ('1598206433184473091', '儿童套餐A计划', '61d20592-b37f-4d72-a864-07ad5bb8f3bb.jpg', '1598206150136061954', null, '1415580119015145474', null, '1', '40.00');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='套餐';
...
INSERT INTO `setmeal` VALUES ('1595045284041457665', '1413342269393674242', '套餐1', '1200.00', '1', '', '112', 'bb4757b7-a838-4e97-be84-eab6d4354397.jpg', '2022-11-22 21:23:25', '2022-11-24 17:04:50', '1', '1', '0');
...
CREATE TABLE `setmeal_dish` (
  ...
  `is_deleted` int(11) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='套餐菜品关系';
...
INSERT INTO `setmeal_dish` VALUES ('1595045284137926657', '1595045284041457665', '1397849739276890114', '辣子鸡', '7800.00', '1', '0', '2022-11-22 21:23:25', '2022-11-22 21:23:25', '1', '1', '0');
...
CREATE TABLE `shopping_cart` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=COMPACT COMMENT='购物车';
...
INSERT INTO `user` VALUES ('1596879797122093057', null, '13112341234', null, null, null, '1');
